...
export {exitSurveyJSON, observationJSON, spreadsheet, coordFileName, imageFileName, imageWidth, imageHeight, imageScale, markerRadius};
...
var observationJSON = {"title":"Room 3 Disposable","description":"Observations","pages":[{"name":"page1","elements":[{"type":"comment","name":"notes","title":"Notes","isRequired":true},{"type":"radiogroup","name":"visitWith","title":"Visiting with","choices":["Alone","With other adults","With children or adults+children"]},{"type":"boolean","name":"screen","title":"Did they go behind the screen?","labelTrue":"Yes","labelFalse":"No"}]}]};

// Other variables
const spreadsheet = 'https://script.google.com/macros/s/AKfycby-VIBUUesAfypbDOTFlfcSE2cNLfTUXftB-XlcfQVDfZX8LtQe/exec',
